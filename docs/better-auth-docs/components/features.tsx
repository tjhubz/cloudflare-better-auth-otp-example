...
import { Globe2Icon, PlugIcon, PlugZap2Icon, Plus, RabbitIcon, ShieldCheckIcon, Webhook } from "lucide-react";
                    ...
                    {features.map((feature, index) => (
                        ...
                        >
                            <div className="flex items-center gap-2 my-1">
                                ...
                                <p className="text-gray-600 dark:text-gray-400">{feature.label}</p>
                            </div>
                            <div className="mt-2">
