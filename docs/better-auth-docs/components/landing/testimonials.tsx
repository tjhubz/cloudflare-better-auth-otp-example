...
const testimonials = [
    ...
    },
    {
        ...
        description: "When @better_auth meets @nuxt_hub to build full-stack Nuxt apps on Cloudflare (using D1 & KV).",
...
holy sh** is it good, works so nice with typescript + drizzle`,
    ...
    },
    {
        ...
        description: "@better_auth exceeded all expectations, and it's just getting started",
...
const TestimonialItem = ({
    ...
    return (
        <div className="max-w-full mx-auto">
            <div className={`[--anime-duration:${animeSeconds}s] px-10 mx-auto w-full`}>
                <div
                    style={{
                            ...
                            >
                                ...
                                <div className="flex overflow-hidden h-[28%] gap-1 w-full border-t-[1.2px]">
                                    <div className="flex items-center w-3/4 gap-3 px-4 py-3">
                                        <img src={testimonial.avatar} className="w-10 h-10 rounded-full" alt="avatar" />
        ...
        <div className="max-w-full py-5 mx-auto overflow-hidden">
            <div className="flex flex-col gap-3">
                ...
                >
                    <TestimonialItem
                        testimonials={Array(15)
                            .fill(testimonials.slice(Math.floor(testimonials.length / 2) + 1, testimonials.length - 1))
                            .flat()}
                    />
                </div>
            </div>
