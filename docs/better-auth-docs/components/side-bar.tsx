...
function SidebarTab({ group, setGroup }: { group: string; setGroup: (group: string) => void }) {
    ...
    return (
        ...
        >
            ...
            <SelectContent>
                {tabs.map(tab => (
                    <SelectItem key={tab.value} value={tab.value} className="h-12 flex flex-col items-start gap-1">
