                ...
                <div className="grid gap-4">
                    {options.email && (
                        <>
                            ...
                            <div className="grid gap-2">
                                ...
                                <Input id="password" type="password" placeholder="password" autoComplete="password" />
                            </div>
                    ...
                    <div
                        className={cn(
                            ...
                            options.socialProviders.length > 3 ? "flex-row flex-wrap" : "flex-col"
                        )}
                    >
                        {Object.keys(socialProviders).map(provider => {
                            if (options.socialProviders.includes(provider)) {
                                const { Icon } = socialProviders[provider as keyof typeof socialProviders];
                                return (
                                    <Button
                                        key={provider}
                                        variant="outline"
                                        className={cn(
                                            options.socialProviders.length > 3 ? "flex-grow" : "w-full gap-2"
                                        )}
                                    >
      ...
      <CardContent>
        <div className="grid gap-4">
          ...
          ${
              ...
              ${options.socialProviders.length > 3 ? '"justify-between flex-wrap"' : '"justify-between flex-col"'}
            )}>
