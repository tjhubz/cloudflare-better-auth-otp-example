            ...
            >
                {propTabs.map((tab, idx) => (
                    <button
                        ...
                        className={cn("relative px-4 py-2 rounded-full opacity-80 hover:opacity-100")}
                    >
                        {active.value === tab.value && (
                            <div className={cn("absolute inset-0 bg-gray-200 dark:bg-zinc-900/90 opacity-100")} />
                        )}
