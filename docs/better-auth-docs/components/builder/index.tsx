                                    ...
                                    <CardContent className="max-h-[400px] overflow-scroll">
                                        <div className="flex flex-col gap-2">
                                            ...
                                            <div className="flex items-center justify-between">
                                                <div className="flex items-center">
                                                    <Label className="cursor-pointer" htmlFor="email-provider-email">
                                                        Enabled
                                                    </Label>
                                                </div>
                                                <Switch
                                        ...
                                        <div className="flex flex-col gap-2 mt-4">
                                            ...
                                            {Object.entries(socialProviders).map(([provider, { Icon }]) => (
                                                <div className="flex items-center justify-between" key={provider}>
                                                    <div className="flex items-center gap-2">
                                                        <Icon />
                                                        <Label
                                                            className="cursor-pointer"
                                                            htmlFor={"social-provider".concat("-", provider)}
                                                        >
                                                        ...
                                                        onCheckedChange={checked => {
                                                            setOptions(prev => ({
                                                                ...
                                                                socialProviders: checked
                                                                    ...
                                                                    : prev.socialProviders.filter(p => p !== provider),
                                                            }));
                                                        }}
                                                    />
                                                </div>
                                        ...
                                        <div className="flex flex-col gap-2 mt-4">
                                            ...
                                            <div className="flex items-center justify-between">
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <Label className="cursor-pointer" htmlFor="plugin-passkey">
                                                        Passkey
                                                    </Label>
                                                </div>
                                                <Switch
                                            ...
                                            <div className="flex items-center justify-between">
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <Label className="cursor-pointer" htmlFor="plugin-otp-magic-link">
                                                        Magic Link
                                                    </Label>
                                                </div>
                                                <Switch
                                        ...
                                        <div className="mt-4">
                                            ...
                                            <div className="flex items-center justify-between mt-2">
                                                <Label className="cursor-pointer" htmlFor="label-powered-by">
                                ...
                                <Card className="rounded-none flex-grow  h-full">
                                    ...
                                    <CardContent className="flex items-start gap-2 flex-wrap justify-between">
                                        {frameworks.map(fm => (
                                            ...
                                            >
                                                {fm.title !== "Next.js" && (
                                                    <span className="absolute top-4 right-4 text-xs">Coming Soon</span>
                                                )}
                                                <fm.Icon />
                                ...
                                <Card className="rounded-none w-full overflow-y-hidden h-full overflow-auto">
                                    ...
                                    <CardContent>
                                        <div className="flex gap-2 items-baseline">
                                            <p>Copy the code below and paste it in your application to get started.</p>
                                            <p
                                                className="text-blue-400 hover:underline mt-1 text-sm cursor-pointer"
                                                onClick={() => {
                                                    setCurrentStep(0);
