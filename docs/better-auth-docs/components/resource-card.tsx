...
export function ResourceCard({ title, description, href, tags, className }: ResourceCardProps) {
    return (
        <div
            className={cn(
            ...
            <div>
                ...
                <div className="p-4 py-0 flex items-start justify-between">
                    <a href={href} target="_blank" rel="noopener noreferrer">
                        <h3 className="font-semibold text-md tracking-tight no-underline">{title}</h3>
                    </a>
                </div>
                <p
