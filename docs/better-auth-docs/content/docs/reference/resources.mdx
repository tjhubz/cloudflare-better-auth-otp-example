...
<Resource
    resources={[
        ...
        },
        {
            ...
            description: "An introductory overview and demonstration of Better Auth's core features and capabilities.",
        ...
        },
        {
            ...
            description:
                "<strong>Jack</strong> demonstrates how to implement headless authentication in your TanStack Start application using Better Auth, providing a modern approach to auth.",
...
<Resource
    resources={[
        ...
        },
        {
            ...
            description: "Step by step guide on how to authenticate users in Astro with Better Auth.",
        ...
        },
        {
            ...
            description: "Learn how to build multi-tenant apps with Better-Auth and ZenStack.",
