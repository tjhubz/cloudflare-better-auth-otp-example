        ...
        <div className="min-h-screen bg-transparent overflow-hidden">
            ...
            <div className="relative py-24">
                ...
                <div className="max-w-6xl mx-auto px-6 relative z-10">
                    <h2 className="text-3xl font-bold mb-12 font-geist text-center">What does V1 means?</h2>
                    <p>
                        Since introducing Better Auth, the community's excitement has been incredibly motivating—thank
                        you! <br /> <br />
                        V1 is an important milestone, but it simply means we believe you can use it in production and
                        that we'll strive to keep the APIs stable until the next major version. However, we'll continue
                        improving, adding new features, and fixing bugs at the same pace as before.
                        <br /> <br />
                        If you were using Better Auth for production, we recommend updating to V1 as soon as possible.
                        There are some breaking changes, feel free to join us on{" "}
                        <Link href="https://discord.gg/better-auth">Discord</Link>, and we'll gladly assist.
                    </p>
                </div>
            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div>
                        ...
                        <div className="dark:bg-white/5 bg-black/10 rounded-lg p-4 mb-2">
                            <code className="text-sm font-mono">npm i better-auth@latest</code>
                        </div>
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-400">
                            ...
                            <a href="/docs/concepts/database#core-schema" className="underline">
                                Core Schema
                            </a>{" "}
                    ...
                    <div>
                        ...
                        <Link className="w-full" href="https://github.com/better-auth/better-auth">
                        ...
                        <Link className="w-full" href="https://discord.gg/better-auth">
                            <Button variant="outline" className="w-full justify-between border-t-0">
                                <div className="flex items-center gap-2">
                                    <DiscordLogoIcon />
                                    Join Discord
                                </div>
