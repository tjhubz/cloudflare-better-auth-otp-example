...
export async function GET(req: Request) {
    try {
        ...
        const geistMono = await fetch(new URL("../../../assets/GeistMono.ttf", import.meta.url)).then(res =>
            res.arrayBuffer()
        );
        ...
        const trueHeading = heading.length > 140 ? `${heading.substring(0, 140)}...` : heading;
        ...
        return new ImageResponse(
            (
                ...
                >
                    <div tw={`relative flex flex-col w-full h-full border-2 border-[${paint}]/20 p-10}`}>
                        <svg
                            style={{
                                position: "absolute",
                                top: "-9px",
                        ...
                        <div tw="flex items-center w-full justify-between">
                            <div tw="flex text-xl" style={{ fontFamily: "GeistSans", fontWeight: "semibold" }}>
                                Better Auth.
                            </div>
